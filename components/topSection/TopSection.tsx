...
export default function TopSection() {
    return (
        <div style={{ display: "flex", flexWrap: "wrap", backgroundColor: "var(--backgroundColor)" }}>
            <div style={{ flex: "2 1 300px", display: "flex", flexWrap: "wrap", padding: "1rem", justifyContent: "center", gap: "1rem", backgroundColor: "var(--primaryColor)", clipPath: "polygon(0 0, 100% 0, 95% 100%, 0 100%)" }}>
